...
public class ServiceView extends AbstractService implements IServiceView, ViewSwitcher.ViewFactory {
  ...
  @Override public ISubServeView applicationProxy() {
  ...
  @Override public void toServiceCommand(Intent intent) {
    startService(intent);
  }

  @Override public NotificationManagerCompat notificationManager() {
  ...
  private LayoutParams windowLayoutParams() {
    LayoutParams params = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT,
        //Size of View in Window
        LayoutParams.TYPE_SYSTEM_ALERT, //Type of Window
        LayoutParams.FLAG_NOT_FOCUSABLE //Flags
            | LayoutParams.FLAG_NOT_TOUCH_MODAL, PixelFormat.TRANSLUCENT); //Pixel Format
  ...
  @Override public View makeView() {
    ...
    FrameLayout.LayoutParams params =
        new FrameLayout.LayoutParams(FrameLayout.LayoutParams.MATCH_PARENT, //match window width
