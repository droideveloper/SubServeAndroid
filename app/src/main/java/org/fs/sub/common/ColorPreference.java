...
public class ColorPreference extends DialogPreference {
    ...
    public ColorPreference(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = context.getTheme().obtainStyledAttributes(attrs, com.rarepebble.colorpicker.R.styleable.ColorPicker, 0, 0);
            ...
            defaultColor = a.hasValue(com.rarepebble.colorpicker.R.styleable.ColorPicker_colorpicker_defaultColor) ? a.getColor(com.rarepebble.colorpicker.R.styleable.ColorPicker_colorpicker_defaultColor, Color.GRAY) : null;
            showAlpha = a.getBoolean(com.rarepebble.colorpicker.R.styleable.ColorPicker_colorpicker_showAlpha, true);
            showHex = a.getBoolean(com.rarepebble.colorpicker.R.styleable.ColorPicker_colorpicker_showHex, true);
        } else {
    ...
    private View addThumbnail(View view) {
        ...
        LayoutInflater.from(getContext()).inflate(isEnabled() ? com.rarepebble.colorpicker.R.layout.color_preference_thumbnail : com.rarepebble.colorpicker.R.layout.color_preference_thumbnail_disabled, widgetFrameView);
    ...
    private Integer getPersistedIntDefaultOrNull() {
        return getSharedPreferences().contains(getKey()) ? Integer.valueOf(getPersistedInt(Color.GRAY)) : defaultColor;
    }
    ...
    private void showColor(Integer color) {
        ...
        if (thumbnail != null) {
            ...
            thumbnail.findViewById(com.rarepebble.colorpicker.R.id.colorPreview).setBackgroundColor(thumbColor == null ? 0 : thumbColor);
        }
