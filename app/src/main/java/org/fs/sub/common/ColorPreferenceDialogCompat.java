...
public class ColorPreferenceDialogCompat extends PreferenceDialogFragmentCompat {
  ...
  @Override protected void onPrepareDialogBuilder(android.support.v7.app.AlertDialog.Builder builder) {
  ...
  private ColorPreference getColorPreference() {
    return (ColorPreference) this.getPreference();
  }
  ...
  @Override public void onDialogClosed(boolean positiveSelected) {
    if (colorPreference != null) {
      if (positiveSelected) {
